...
class ArtistAliasObserver Extends BaseManicModelObserver
{
    ...
    public function updating($artistAlias)
    {
        ...
        Log::Debug("Updating artist alias", ['artist alias' => $artistAlias->id, 'artist' => $artistAlias->artist->id]);
    }
    ...
    public function updated($artistAlias)
    {
        ...
        Log::Info("Updated artist alias", ['artist alias' => $artistAlias->id, 'artist' => $artistAlias->artist->id]);
    }
    ...
    public function saving($artistAlias)
    {
        ...
        Log::Debug("Saving artist alias", ['artist alias' => $artistAlias->id, 'artist' => $artistAlias->artist->id]);
    }
    ...
    public function deleting($artistAlias)
    {
        ...
        Log::Debug("Deleting artist alias", ['artist alias' => $artistAlias->id, 'artist' => $artistAlias->artist->id]);
