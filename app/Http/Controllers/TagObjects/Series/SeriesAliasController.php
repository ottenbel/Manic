...
class SeriesAliasController extends WebController
{
    /**
    ...
    public function index(Request $request)
    {
		...
		return View('tagObjects.series.alias.index', array('aliases' => $aliases->appends(Input::except('page')), 'list_type' => $alias_list_type, 'list_order' => $alias_list_order, 'messages' => $messages));
    }
    ...
    public function store(Request $request, Series $series)
    {
		...
		$messages = self::BuildFlashedMessagesVariable(["Successfully created alias $seriesAlias->alias on series $series->name."], null, null);
    ...
    public function destroy(SeriesAlias $seriesAlias)
    {
		...
		$messages = self::BuildFlashedMessagesVariable(["Successfully purged alias from series."], null, null);
