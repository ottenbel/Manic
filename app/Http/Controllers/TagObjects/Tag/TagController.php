...
class TagController extends Controller
{
    ...
    public function edit(Request $request, Tag $tag)
    {
		...
		return View('tags.edit', array('tagObject' => $tag, 'global_list_order' => $global_list_order, 'personal_list_order' => $personal_list_order, 'global_aliases' => $global_aliases, 'personal_aliases' => $personal_aliases, 'flashed_success' => $flashed_success, 'flashed_data' => $flashed_data, 'flashed_warning' => $flashed_warning));
    }
