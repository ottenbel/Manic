...
<div class="container">
	...
	@if(($global_aliases->count() > 0) 
		...
		@if($global_aliases->count() > 0)
			<div>
				...
				@if($global_list_order == "asc")
					<b><a href="{{route('show_artist', ['artist' => $artist])}}?global_order=asc">Ascending</a></b> <a href="{{route('show_artist', ['artist' => $artist])}}?global_order=desc">Descending</a>
				@elseif($global_list_order == "desc")
					<a href="{{route('show_artist', ['artist' => $artist])}}?global_order=asc">Ascending</a> <b><a href="{{route('show_artist', ['artist' => $artist])}}?global_order=desc">Descending</a></b>
				@endif
			</div>
		...
		@can('create', [App\Models\TagObjects\Artist\ArtistAlias::class, true])
			<form method="POST" action="{{route('store_artist_alias', ['artist' => $artist])}}" enctype="multipart/form-data">
				{{ csrf_field() }}
		...
		@if($personal_aliases->count() > 0)
			<div>
				...
				@if($personal_list_order == "asc")
					<b><a href="{{route('show_artist', ['artist' => $artist])}}?personal_order=asc">Ascending</a></b> <a href="{{route('show_artist', ['artist' => $artist])}}?personal_order=desc">Descending</a>
				@elseif($personal_list_order == "desc")
					<a href="{{route('show_artist', ['artist' => $artist])}}?personal_order=asc">Ascending</a> <b><a href="{{route('show_artist', ['artist' => $artist])}}?personal_order=desc">Descending</a></b>
				@endif
			</div>
