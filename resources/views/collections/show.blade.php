...
<div class="container">
	...
	<div id="collection_summary">
		...
		@endif		
			...
			<div>
				<strong>Created By:</strong> <a href="/user/{{$collection->id}}">{{{$collection->created_by_user()->get()->name}}}</a> @ {{$collection->created_at}}
			</div>
			
			<div>
				<strong>Updated By:</strong> <a href="/user/{{$collection->id}}">{{{$collection->updated_by_user()->get()->name}}}</a> @ {{$collection->updated_at}}
			</div>
	</div>
