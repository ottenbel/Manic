...
@section('content')
	@include('partials.tagObjects.alias.index-content', ['tagObjectName' => 'character', 'tagObjectNames' => 'characters', 'indexAliasRoute' => 'index_character_alias', 'indexRoute' => 'index_character', 'showRoute' => 'show_character', 'globalAliasDisplayClass' => 'global_character_alias', 'personalAliasDisplayClass' => 'personal_character_alias', 'classAliasModelPath' => App\Models\TagObjects\Character\CharacterAlias::class])
@endsection
