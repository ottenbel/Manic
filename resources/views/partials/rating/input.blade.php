<div class="form-group">
	...
	@if((!empty($rating)) && ($rating->name != null) && (Input::old('name') == null))
		{{ Form::text('name', $rating->name, array('class' => 'form-control', 'placeholder' => $configurations['name']->value)) }}
	@else
...
<div class="form-group">
	...
	@if((!empty($rating)) && ($rating->priority != null) && (Input::old('priority') == null))
		{{ Form::text('priority', $rating->priority, array('class' => 'form-control', 'placeholder' => $configurations['priority']->value)) }}
	@else
